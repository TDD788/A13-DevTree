...
export TARGET_DEVICE_ALT="a13, a13ub, SM-A135M, SM-A135F"
...
export_build_vars(){
	...
	export FOX_USE_SPECIFIC_MAGISK_ZIP="$PWD/device/samsung/a13/prebuilt/magisk/magdelta.zip"
...
var_not_eq(){
        echo -e "${RED_BACK}CURR_DEVICE not equal to a13${RESET}"
